...
<body class="bg-blue-50">
    <div class="m-4">
        ...
        <form method="POST" action="{{route('paymentdone',['packagePrice' => $packagePrice])}}" class="credit-card w-full sm:w-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
            @csrf
